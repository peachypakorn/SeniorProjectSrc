...
void pyrbuild_top(cmpxDataOut  fftTmp[512],
			      ...
			      int width,
                  const int nL){
	#pragma HLS INTERFACE ap_fifo depth=1024 port=fftTmp
	#pragma HLS INTERFACE ap_fifo depth=2048 port=fftPyrFilOut
...
#pragma HLS interface ap_fifo depth=1024 port=ovflo
...
#pragma HLS interface ap_fifo depth=1024 port=imgIn
#pragma HLS interface ap_fifo depth=2048 port=pyrFilOut
...
//#pragma HLS STREAM variable=imgInTmp depth=1024 dim=1
//#pragma HLS STREAM variable=imgOutTmpFFTStream depth=1024 dim=1
//#pragma HLS STREAM variable=fftPyrOut depth=2048 dim=1
#pragma HLS interface ap_fifo depth=1024 port=imgOutTmpFFTStream
#pragma HLS interface ap_fifo depth=1024 port=imgInTmp
#pragma HLS interface ap_fifo depth=2048 port=fftPyrOut
...
#pragma HLS STREAM variable=imgIn depth=1024 dim=1
#pragma HLS DATA_PACK variable=pyrFilOut
#pragma HLS DATA_PACK variable=imgIn
#pragma HLS DATAFLOW
#pragma HLS INTERFACE axis depth=2048 port=pyrFilOut
#pragma HLS INTERFACE axis depth=1024 port=imgIn
